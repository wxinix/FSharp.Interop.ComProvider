...
[Microsoft](https://docs.microsoft.com/en-us/dotnet/fsharp/tutorials/type-providers/) defines an F# Type Provider as 
...
COM Type Provider is a F# type provider using registered COM type libraries as the data source, while providing a new way to do COM interop from F#.

This repo is adapted from the [fsprojects/FSharp.Interop.ComProvider](https://github.com/fsprojects/FSharp.Interop.ComProvider) project. You can find the [original documentation](http://fsprojects.github.io/FSharp.ComProvider/) here.  

Note, this repo is independently updated and maintenained by Wuping Xin (https://github.com/wxinix), serving as a personal "dogfooding" project in F# language.
